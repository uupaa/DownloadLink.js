...
DownloadLink["prototype"] = Object.create(DownloadLink, {
    ...
    "create": { "value": DownloadLink_create }, // #create(buffer:Array, options:Object = null):Boolean
});

// --- implements ------------------------------------------
function DownloadLink_create(buffer,    // @arg Array - Array of TypedArray|ArrayBuffer|Array|String objects
...
//{@dev
    if (VERIFY) {
        $valid($type(buffer,  "Array"), DownloadLink_create, "buffer");
